  ...
  return (
    <div className="flex items-center">
      <motion.div
        ...
        initial={{ x: 0 }}
        animate={{ x: [0, 20, 0] }}
        className="h-4 w-4 rounded-full bg-blue-500 shadow-md dark:bg-neutral-500"
      />
      <motion.div
        initial={{ x: 0 }}
        animate={{ x: [0, 20, 0] }}
      ...
      <motion.div
        ...
        className="h-4 w-4 -translate-x-4 rounded-full bg-blue-300 shadow-md dark:bg-neutral-500"
      />
    </div>
  );
};
